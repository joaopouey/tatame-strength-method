      ...
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold">Histórico de Exercícios</h1>
          ...
          <Card className="mt-6">
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-primary">{exerciseLogs.length}</p>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Exercícios Únicos</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-primary">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Maior Peso</p>
                </div>
              </div>
            </CardContent>
          </Card>
